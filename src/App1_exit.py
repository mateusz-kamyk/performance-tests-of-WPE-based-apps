...
from Test_summary_script import *
        ...
        while True:
            ...
            while True:
                ...
                if max_val > 0.98:
                    ...
                    print('T5T', '{}'.format(end_time - start_time))
                    repeat = 0
                    T5T.append((utils.no, (end_time - start_time).total_seconds()))
                    break

                elif datetime.now() > loop_time_end:
                    print('T5T', 'Time exceeded - unsuccessful test')
                    repeat = 1
                    App_launching.App1()
                    time.sleep(25)
                    break                
